...
class JobListItem extends StatelessWidget {
  ...
  Widget _buildCompanyBadge(TextTheme textTheme) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: ContextColors.accent.withAlpha(76)),
      ),
      child: Text(
        job.company.name,
  ...
  Widget _buildRemoteBadge() {
    return Container(
      ...
      decoration: const BoxDecoration(color: ContextColors.success),
      child: const Row(
  ...
  Widget _buildMorePerksTag() {
    ...
    return Container(
      ...
      decoration: const BoxDecoration(color: ContextColors.textPrimary),
      child: Text(
        '+$remainingCount more',
        style: const TextStyle(
          fontSize: 11,
  ...
  Widget _buildFooter(TextTheme textTheme) {
    return Container(
      ...
      decoration: const BoxDecoration(color: ContextColors.borderDark),
      child: Row(
